...
$errorData = editValidate(firstName: $_POST['firstName'], lastName: $_POST['lastName'], nik: $_POST['nik'], email: $_POST['email'], id: $_SESSION['personId'], birthDate: $_POST['birthDate']);
