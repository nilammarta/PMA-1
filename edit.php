                  ...
                  <div class="d-lg-flex gap-lg-3 gap-xl-5">
                    <div class="form-1">
                      <div class="mb-3">
                        ...
                        <!-- <div class="invalid-tooltip">Type the valid First name</div> -->
                      </div>
                    ...
                    <div class="form-2">
                      <div class="mb-3">
                        ...
                        >
                          ...
                          <!-- <option class="option-value" value="2">Female</option> -->
                        </select>
                      </div>
                      ...
                      <div class="mb-3">
                        ...
                        >
                          ...
                          <option class="option-value" value="2">Member</option>
                        </select>
