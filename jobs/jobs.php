        ...
        <div class="jobs m-3 m-md-4">
                    ...
                    <button class="btn btn-search d-flex me-2" type="submit">
                      ...
                      <?php if (isset($_GET['search'])) { ?>
                        <a role="button" class="btn btn-search pb-2 d-flex" type="reset" href="jobs.php">
                          <ion-icon class="reset-icon me-1" name="reload-outline"></ion-icon>
                          Reset
                        </a>
                      <?php } ?>
                  </form>
          ...
          <div class="table-data" id="table">
            <div class="table-responsive ms-xxl-5 me-xxl-5">
                ...
                $jobs = getPaginatedJobs(limit: $limit, page: $page, search: $_GET['search']);
                if ($jobs['totalPage'] < $_GET['page']) {
                    $page = 1;
                    $jobs = getPaginatedJobs(limit: $limit, page: $page, search: $_GET['search']);
                }
                                ...
                                <!-- delete jobs -->
                                  <?php if ($count != "0") { ?>
                                    <a role="button" class="btn btn-danger"
                                       href="/action/delete-job-action.php?<?php echo $url; ?>page=<?php echo $_GET['page']; ?>&jobId=<?php echo $jobsPaging[$i]['ID']; ?>">
